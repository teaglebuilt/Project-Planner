        ...
        <div class="container">
          ...
          <div class="row center">
            <h5 class="header col s12 light">
              Track your projects. This application is built with React.JS,
              Redux, and Firebase. This is a demo application strictly for
              purpose of a demonstration. Feel free to try/test it as you see
              fit.
            </h5>
          </div>
          <div class="row center">
            <a
              href="https://github.com/teaglebuilt/Project-Planner"
              id="download-button"
              class="btn-large waves-effect waves-light indigo darken-4"
            >
              Check out the Repo
            </a>
          </div>
